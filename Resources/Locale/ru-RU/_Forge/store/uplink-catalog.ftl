...
uplink-security-mech-ares-desc = Тяжелый аргумент для подавления беспорядков, прорыва укреплений, эвакуации под огнем и противодействия тяжелым угрозам внутренней и внешней безопасности. "Железный кулак" ДШНФ.
...
uplink-security-nfsdgasalt-name = тактический противогаз ДШНФ
uplink-security-nfsdgasalt-desc = Модифицированная версия стандартного противогаза ДШНФ, обеспечивающая повышенный комфорт при длительном ношении.
uplink-security-nfsdgascoroner-name = противогаз коронера ДШНФ
...
uplink-security-nfsdgasup-name = продвинутый противогаз ДШНФ
uplink-security-nfsdgasup-desc = Версия противогаза, разработанная для опасных операций и экстремальных условий.
uplink-security-engibelt-name = пояс специалиста ДШНФ (Заполненный)
uplink-security-engibelt-desc = Тактический пояс с креплениями под инструменты специалиста и аварийное оборудование. Включает в себя комплект инструментов ДШНФ.
...
forge-uplink-security-magbootspro-name = продвинутые магнитные сапоги ДШНФ
