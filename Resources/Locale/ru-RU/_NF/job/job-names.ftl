...
# Forge
job-name-security-guard = Офицер Безопасности
job-name-stc = Координатор
job-name-sr = Управляющий
job-name-doc = Директор TTI
# Forge end
job-name-pal = Общ. Представитель
...
# Forge
JobSecurityGuard = Офицер Безопасности
# Forge end
