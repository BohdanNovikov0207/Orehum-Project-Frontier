...
frontier-lobby-nfsd-subtext = Оперативный центр ДШНФ.
...
frontier-lobby-nfsd-description = Департамент Шерифа Нового Фронтира — оперативный центр ДШНФ. Здесь вы можете:
   - Присоединиться к ДШНФ
