...
ent-TsfCommandingOfficerPDA = КПК шерифа ДШНФ
    .desc = { ent-SheriffPDA.desc }
ent-TsfExecutiveOfficerPDA = КПК исполнительного офицера ДШНФ
    .desc = { ent-BailiffPDA.desc }
ent-TsfSeniorOfficerPDA = КПК старшего офицера ДШНФ
    .desc = { ent-SergeantPDA.desc }
ent-TsfSeniorAidePDA = КПК младшего офицера ДШНФ
    .desc = { ent-PublicAffairsLiaisonPDA.desc }
ent-TsfAmbassadorPDA = КПК посла федерации
    .desc = { ent-SrPDA.desc }
ent-TsfRangerPDA = КПК морпеха ДШНФ
    .desc = { ent-DeputyPDA.desc }
ent-TsfRecruitPDA = КПК новобранца ДШНФ
