...
ent-TSFTrackingImplant = имплант трекер ДШНФ
    .desc = Этот имплант показывает местоположения пользователя для сервера мониторинга ДШНФ и оповещает о смерти в канал ДШНФ.
