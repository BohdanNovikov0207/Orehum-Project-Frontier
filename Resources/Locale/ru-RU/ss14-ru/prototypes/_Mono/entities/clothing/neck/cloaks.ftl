...
ent-ClothingNeckColonelCloak = плащ шерифа ДШНФ
    .desc = Официальный плащ ДШНФ для шерифа с полномочиями в секторе, с нашивками звания и отделкой.
ent-ClothingNeckCaptainCloak = плащ капитана ДШНФ
    .desc = Стильный плащ ДШНФ для капитана и исполнительного офицера морского десанта.
