...
ent-ClothingUniformJumpsuitNfsd = костюм ДШНФ
    .desc = Костюм с длинными рукавами, сшитый для помощника шерифа. Предназначен для уменьшения натирания кожи, слизи, чешуи, пуха и древесины в промежности.
ent-ClothingUniformJumpsuitNfsdShort = комбинезон ДШНФ
    .desc = Костюм с коротким рукавами, сшитый для помощника шерифа. Предназначен для уменьшения натирания кожи, слизи, чешуи, пуха и древесины в промежности.
...
ent-ClothingUniformJumpsuitSr = униформа представителя станции
    .desc = Первоклассный наряд для управляющего фронтира На пошив не было потрачено ни копейки, каждый шов - шедевр. Тот факт, что этот костюм был выдан, говорит о доверии УСФ к своему представителю на этом форпосте.
