ent-WeaponRifleLecter = TCA M-6 «Лектер» (6,8×52 мм безгильзовый)
    .desc = Проект нового стандартного ружья для вооружённых сил ДШНФ. Точное и удобное, стреляет безгильзовым 6,8×52 мм STANAG; также принимает магазины 5,56×45 мм для унификации боекомплекта.
