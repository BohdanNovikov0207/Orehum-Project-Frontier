...
ent-WeaponShotgunAD12 = Отбойник
    .desc = Автоматический Дробовик 12 модели поставляется ограниченными партиями для сил ДШНФ компанией TechnicLogistic, барабанная система подачи боеприпасов позволяет оружию развить чудовищную скорострельность и убойную силу.
    .suffix = TechnicLogistic
